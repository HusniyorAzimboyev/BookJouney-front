...
class LiteratureCatalog {
    ...
    showLiteratureCategory(category, clickedElement) {
        ...
        if (clickedElement && clickedElement.classList) clickedElement.classList.add('active');
            ...
            const btn = Array.from(document.querySelectorAll('.category-btn')).find(b => b.getAttribute('onclick')?.includes(`showLiteratureCategory('${category}')`));
